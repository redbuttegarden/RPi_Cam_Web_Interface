...
All information on the original project can be found here: http://www.raspberrypi.org/forums/viewtopic.php?f=43&t=63276

The wiki page for the original project can be found here:
...
https://github.com/redbuttegarden/RPi_Cam_Web_Interface/commits/master/
  
This version has updates for php8.4 / Trixie. May need further changes for nginx
